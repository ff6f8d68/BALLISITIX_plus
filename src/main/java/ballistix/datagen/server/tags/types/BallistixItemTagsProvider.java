...
public class BallistixItemTagsProvider extends ItemTagsProvider {
	...
	public BallistixItemTagsProvider(PackOutput output, CompletableFuture<Provider> lookupProvider, BlockTagsProvider provider, ExistingFileHelper existingFileHelper) {

...
public class BallistixLangKeyProvider extends VoltaicLangKeyProvider {
	...
	protected void addTranslations() {
		...
		default:
			...
			addBlock(BallistixBlocks.blockMissileSilo.get(), "Missile Silo");
            addBlock(BallistixBlocks.blockRadar.get(), "Search Radar");
            addBlock(BallistixBlocks.blockFireControlRadar.get(), "Fire Control Radar");
            addBlock(BallistixBlocks.blockSamTurret.get(), "SAM Turret");
            addBlock(BallistixBlocks.blockEsmTower.get(), "ESM Tower");
            addBlock(BallistixBlocks.blockCiwsTurret.get(), "CIWS Turret");
            addBlock(BallistixBlocks.blockLaserTurret.get(), "Laser Turret");
            addBlock(BallistixBlocks.blockRailgunTurret.get(), "Railgun Turret");
            
            addBlock(BallistixPlusBlocks.blockHorizontalMissileSilo.get(), "Horizontal Missile Silo");
            ...
            addItem(BallistixPlusItems.ITEM_RANGEDESIGNATOR, "Range Designator");
            addItem(BallistixPlusItems.ITEM_HORIZONTALSILO, "Horizontal Missile Silo");

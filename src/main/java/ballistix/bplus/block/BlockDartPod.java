...
public class BlockDartPod extends GenericMachineBlock implements IMultiblockParentBlock {

    public BlockDartPod() {
        super(TileDartPod::new);
    }

    public static final Subnode[] SUBNODES_SOUTH = new Subnode[1];
    public static final Subnode[] SUBNODES_NORTH = new Subnode[1];
    public static final Subnode[] SUBNODES_EAST = new Subnode[1];
    public static final Subnode[] SUBNODES_WEST = new Subnode[1];

    static {
        // 1x1x2 silo. Core at 0,0,0.
        // 1 block wide (X: 0), 1 block high (Y: 0), 2 blocks long (Z: 0 to 1)
